...
import edu.uob.GameEngine.GameController;
...
public final class GameServer {
    ...
    public static void main(String[] args) throws IOException, ParseException, ParserConfigurationException, SAXException, GameException {
    ...
    *
    */
    public GameServer(File entitiesFile, File actionsFile) throws IOException, ParseException, ParserConfigurationException, SAXException, GameException {
    ...
    */
    public String handleCommand(String command) {
        try {
            return controller.parseCommand(command);
