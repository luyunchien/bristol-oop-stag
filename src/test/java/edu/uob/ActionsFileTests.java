...
final class ActionsFileTests {
  ...
  void testBasicActionsFileIsReadable() {
      try {
          ...
          Document document = builder.parse("config/basic-actions.xml");
          ...
          Element secondAction = (Element)actions.item(3);
          Element triggers2 = (Element)secondAction.getElementsByTagName("triggers").item(0);
          // Get the first trigger phrase
          String secondTriggerPhrase = triggers2.getElementsByTagName("keyword").item(0).getTextContent();
          assertEquals("chop", secondTriggerPhrase, "First trigger phrase was not 'chop'");
